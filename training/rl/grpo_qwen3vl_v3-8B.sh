...
swift rlhf \
    ...
    --seed 3407 \
    --data_seed 3407 \
    --model "${SFT_CHECKPOINT:-/path/to/AlloSpatial-sft-8B/checkpoint}" \
    ...
    --output_dir "${OUTPUT_DIR:-./output/AlloSpatial-grpo-8B}" \
    --eval_steps 50 \
    --save_steps 50 \
    --save_total_limit 12 \
    --logging_steps 1 \
    ...
    #     /path/to/AlloSpatial-grpo-8B/checkpoint
    # --eval_on_start True \
